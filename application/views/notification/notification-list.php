...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title><?php echo $sub_sidebar;?></title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><?php echo $sub_sidebar;?></h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted"><?php echo $sub_sidebar;?></li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="flex-lg-row-fluid ms-lg-12">
											...
											<div class="card-header pt-5">
												...
												<div class="card-toolbar">
													...
													<div class="d-flex align-items-center position-relative my-1" data-kt-view-roles-table-toolbar="base">
														...
														<!--end::Svg Icon-->
														<input type="text" data-kt-roles-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search <?php echo $sub_sidebar;?>" />
													</div>
													<!--end::Search-->
													<!--begin::Group actions-->
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--begin::Add user-->
												<!-- <a href="<?php echo base_url().'stock/add_stock_category';?>" class="btn btn-primary">
												...
												<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th class="min-w-300px">Notification</th>
												...
												if ($noti_record) {
													...
													foreach ($noti_record as $key => $value) {
														...
														<tr>
															...
															<!--end::Checkbox-->
															<!--begin::ID-->
															<td><?php echo $value->noti_message;?></td>
															<!--begin::ID-->
															<!--begin::User=-->
															 <td>
															 	<?php 
																if($value->noti_status==1){
																	?>
																	<div class="badge badge-light-success fw-bolder">Read</div>
																	<?php
																}else{
																	?>
																	<div class="badge badge-light-danger fw-bolder">Unread</div>
																	<?php
																}
																?>
															</td>
															<!--end::user=-->
															<!--begin::Joined date=-->
															 <td><?php echo date("d-M-Y", strtotime($value->noti_created_on));?></td>
															<!--end::Joined date=-->
															<!--begin::Action=-->
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	<!--begin::Menu item-->
																	<?php
																	if ($value->url_created!="") {
																		?>
																		<div class="menu-item px-3">
																			<a href="<?php echo base_url().$value->url_created.'/'.$value->noti_id;?>" class="menu-link px-3">View</a>
																		</div>
																		<?php
																	}
																	?>
																	...
																	<div class="menu-item px-3">
																		<a href="<?php echo base_url().'notification/mark_notification/'.$value->noti_id?>" class="menu-link px-3">Mark Read</a>
																	</div>
																	<div class="menu-item px-3">
																		<a href="<?php echo base_url().'notification/remove_notification/'.$value->noti_id?>" class="menu-link px-3">Remove</a>
																	</div>
																	<!--end::Menu item-->
																</div>
																<!--end::Menu-->
		...
		<script src="<?php echo base_url();?>assets/js/custom/apps/user-management/roles/view/view.js"></script>
		<script src="<?php echo base_url();?>assets/js/custom/apps/user-management/roles/view/update-role.js"></script>
