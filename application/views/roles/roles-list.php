									...
									<div class="flex-lg-row-fluid ms-lg-12">
											...
											<div class="card-header pt-5">
												...
												<div class="card-toolbar">
													...
													<div class="d-flex align-items-center position-relative my-1" data-kt-view-roles-table-toolbar="base">
														...
														<!--end::Svg Icon-->
														<input type="text" data-kt-roles-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search <?php echo $page_title;?>" />
													</div>
													<!--end::Search-->
													<!--begin::Group actions-->
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-role')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'roles/add_roles';?>" class="btn btn-primary">
										...
										<!--end::Card toolbar-->
											...
											<div class="card-body pt-0">
												...
												<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th class="min-w-125px">Employee category</th>
												...
												if ($roles_record) {
													$i=0;
													foreach ($roles_record as $key => $value) {
														$i++;
														?>
														<tr>
															<!--begin::Checkbox-->
															...
															<!--begin::User=-->
															 <!-- <td>
															 	<?php 
																if($value->stock_category_status==1){
																	?>
															...
															<!--end::user=-->
															<!--begin::Joined date=-->
															 <td><?php echo date("d-M-Y", strtotime($value->emp_type_created_on));?></td>
															<!--end::Joined date=-->
															<!--begin::Action=-->
															<td class="text-end">
															<!--<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
																...
																<a href="<?php echo base_url().'roles/update_roles/'.$value->emp_type_id?>" class="btn btn-edit btn-active-edit-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Action</a>
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	if ($this->admin->check_user_access('update-role')) {
																		...
																		<div class="menu-item px-3">
																			<a href="<?php echo base_url().'roles/update_roles/'.$value->emp_type_id?>" class="menu-link px-3">Edit</a>
																		</div>
																		<!--end::Menu item-->
																		<?php
																	}
