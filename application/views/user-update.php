								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
													...
													<?php
														foreach ($project_role as $key2 => $value2) {
															?>
																...
																<?php
																if(isset($user_info->user_employee_type))if ($user_info->user_employee_type==$value2->emp_type_id) {
																	echo "selected";
																}
																?>
											...
											<div class="fv-row mb-4">
												<label class=" form-label fs-6 mb-2">Profile</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="user_profile" autocomplete="off" value="<?php if(isset($user_info->user_profile)){echo $user_info->user_profile;}?>"/>

						                        <div style="color: red;"><?php echo form_error('user_profile');?></div>
											</div>
											...
											<!-- <div class="fv-row mb-4">
												...
												<div class="form-check form-check-custom form-check-solid">
													...
													<input class="form-check-input me-3 employee_type_click" name="employee_type" type="radio" value="1" id="kt_modal_update_role_option_0" 
																<?php
																if(isset($user_info->employee_type)){if ($user_info->employee_type==1) {
																	echo "checked";
																}
																}else{
																	echo "checked";}
													...
													<input class="form-check-input me-3 employee_type_click"
																<?php
																if(isset($user_info->employee_type))if ($user_info->employee_type==0) {
																	echo "checked";
																}
																?>    name="employee_type" type="radio" value="0" id="kt_modal_update_role_option_0" >
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<select name="user_status" data-control="select1" data-placeholder="Select Status..." class="form-select form-select-solid form-select-lg">
													...
													<option
																...
																<?php
																if(isset($user_info->user_status))if ($user_info->user_status==$key) {
																	echo "selected";
																}
																?> 
