									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
											...
											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">Location</label>

												<!--begin::Input-->
												<select name="project_location_id" id="project_location_id" aria-label="Select location" data-control="select2" data-placeholder="Select location..." class="form-select form-select-solid form-select-lg">

													<option value="">Select location...</option>
													<?php
														foreach ($project_location as $key2 => $value2) {
															?>
																<option data-kt-flag="flags/indonesia.svg"
																<?php
																if ($user_info[0]->project_location_id==$value2->location_id) {
																	echo "selected";
																}
																?>
																 value="<?php echo $value2->location_id;?>"><?php echo $value2->location_name;?></option>
															<?php
														}
													?>
												...
												<input type="hidden" name="user_id" value="<?php if(isset($user_info[0]->user_id)){echo $user_info[0]->user_id;}?>">
											...
											<div class="text-center pt-15">
												<button type="submit" name="btn_update_location" class="btn btn-primary" data-kt-users-modal-action="submit">
