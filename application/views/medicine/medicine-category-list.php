										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-medicine-category')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'medicine/add_category';?>" class="btn btn-primary">
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a class="text-gray-800 text-hover-primary mb-1"><?php echo $value->med_cat_name;?></a>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'medicine/update_category/'.$value->med_cat_id?>" class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
																<?php
															}
