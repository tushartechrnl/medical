									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
											...
											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">Agency Name</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="agency_name" autocomplete="off" value="<?php if(isset($medicine_info->agency_name)){echo $medicine_info->agency_name;}?>"/>

												<input class="form-control form-control-lg form-control-solid" type="hidden" placeholder="" name="agency_id" autocomplete="off" value="<?php if(isset($medicine_info->agency_id)){echo $medicine_info->agency_id;}?>"/>

						                        <div style="color: red;"><?php echo form_error('agency_name');?></div>
											</div>
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<select name="agency_status" data-control="select1" data-placeholder="Select Status..." class="form-select form-select-solid form-select-lg">
													...
													<option value="<?php echo $key;?>"
														...
														<?php
														if(isset($medicine_info->agency_status)){
															if ($medicine_info->agency_status==$key) {
