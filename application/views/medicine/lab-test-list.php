										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-lab-test')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'medicine/add_lab_test';?>" class="btn btn-primary">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px">Lab Test Name</th>
											...
											<tbody class="text-gray-600 fw-bold">
												...
												if ($lab_test_record) {
													$i=0;
													foreach ($lab_test_record as $key => $value) {
														$i++;
														?>
												<!--begin::Table row-->
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a class="text-gray-800 text-hover-primary mb-1"><?php echo $value->lab_test_name;?></a>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'medicine/update_lab_test/'.$value->lab_test_id?>" class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
																<?php
															}
