									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
											...
											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">Lab Test Name</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="lab_test_name" autocomplete="off" value="<?php if(isset($medicine_info->lab_test_name)){echo $medicine_info->lab_test_name;}?>"/>

												<input class="form-control form-control-lg form-control-solid" type="hidden" placeholder="" name="lab_test_id" autocomplete="off" value="<?php if(isset($medicine_info->lab_test_id)){echo $medicine_info->lab_test_id;}?>"/>

						                        <div style="color: red;"><?php echo form_error('lab_test_name');?></div>
											</div>
