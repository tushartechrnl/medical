									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
											...
											<div class="fv-row mb-4">
												...
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_mfg" autocomplete="off" value="<?php if(isset($medicine_info->med_mfg)){echo $medicine_info->med_mfg;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_mfg');?></div>
											</div>

											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">Unit</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_unit" autocomplete="off" value="<?php if(isset($medicine_info->med_unit)){echo $medicine_info->med_unit;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_unit');?></div>
											</div>


											<div class="fv-row mb-4">
												<label class=" form-label fs-6 mb-2">Scheme</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_scheme" autocomplete="off" value="<?php if(isset($medicine_info->med_scheme)){echo $medicine_info->med_scheme;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_scheme');?></div>
											</div>


											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">MRP</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_mrp" autocomplete="off" value="<?php if(isset($medicine_info->med_mrp)){echo $medicine_info->med_mrp;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_mrp');?></div>
											</div>

											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">Rate</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_rate" autocomplete="off" value="<?php if(isset($medicine_info->med_rate)){echo $medicine_info->med_rate;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_rate');?></div>
											</div>

											<div class="fv-row mb-4">
												<label class=" form-label fs-6 mb-2">Disc %</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_disc" autocomplete="off" value="<?php if(isset($medicine_info->med_disc)){echo $medicine_info->med_disc;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_disc');?></div>
											</div>

											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">HSN</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_hsn" autocomplete="off" value="<?php if(isset($medicine_info->med_hsn)){echo $medicine_info->med_hsn;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_hsn');?></div>
											</div>
											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2">Gst %</label>
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="med_gst_per" autocomplete="off" value="<?php if(isset($medicine_info->med_gst_per)){echo $medicine_info->med_gst_per;}?>"/>

						                        <div style="color: red;"><?php echo form_error('med_gst_per');?></div>
											</div>
