										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-treatment')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'patient/add_treatment/'.$this->uri->segment("3");?>" class="btn btn-primary">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<tr>
													...
													<td>
															...
															<?php 
																...
																foreach ($detal_adv_record as $key21 => $value21) {
																	foreach ($ttm_deails as $key22 => $value22) {

																		if ($value21->ttmad_id==$value22->ttm_treatment) {
																			echo $value21->ttmad_name.", ";
																		}
																	}
																}
															?>
													...
													<!--end::Last login=-->
													<!--begin::Joined-->
													<td><?php echo $value->ttm_fees;?> /-</td>
													<td>
														<?php if($value->total_payment){echo $value->total_payment.' /-';}else{echo '0'.' /-';}?>
													</td>
													...
													echo $employee_type_se[$value->ttm_status];?> </td>
													<td><?php 
												...
												if ($this->admin->check_user_access('update-treatment')) {
													?>
															<a href="<?php echo base_url().'patient/update_treatment/'.$value->ttm_id.'/'.$value->ttm_user_id;?>" class="menu-link px-3">Edit</a>

												<?php
												}
												if ($this->admin->check_user_access('payment-list')) {
													?>
															<a href="<?php echo base_url().'patient/payment/'.$value->ttm_id.'/'.$value->ttm_user_id;?>" class="menu-link px-3">Payment</a>
