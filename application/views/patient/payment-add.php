									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
											...
											<div class="fv-row mb-10">
												<label class="form-label fw-bold fs-6 mb-2 required">Amount</label>
												<input type="hidden" name="payment_user_id" value="<?php echo $this->uri->segment('4');?>">
												<input type="hidden" name="payment_ttm_id" value="<?php echo $this->uri->segment('3');?>">
												<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="payment_fees" autocomplete="off" value="<?php if(isset($dental_info->payment_fees))echo $dental_info->payment_fees;?>"/>

						                        <div style="color: red;"><?php echo form_error('payment_fees');?></div>
											</div>
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<select name="payment_mode" aria-label="Select payment mode" data-control="select2" data-placeholder="Select payment mode ..." class="form-select form-select-solid form-select-lg" >
													<!-- <option value="">Select payment mode...</option> -->
													
													<?php

														foreach ($payment_option_record as $key2 => $value2) {
															?>
																<option data-kt-flag="flags/indonesia.svg"
																<?php
																if(isset($dental_info->payment_mode))
																{
																	
																	if ($dental_info->payment_mode==$value2->option_id) {
																		echo "selected";
																	}
						                        ...
						                        <div style="color: red;"><?php echo form_error('payment_mode');?></div>
											</div>

											<div class="fv-row mb-10">
												<label class="form-label fw-bold fs-6 mb-2 ">Transaction Details</label>
												<textarea class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="payment_paid_via" autocomplete="off"><?php if(isset($dental_info->payment_paid_via))echo $dental_info->payment_paid_via;?></textarea>
						                        <div style="color: red;"><?php echo form_error('payment_paid_via');?></div>
											</div>
											<!--end::Input group=-->

											<!--begin::Actions-->
											<div class="text-center pt-15">
												<button type="submit" name="btn_add_payment" class="btn btn-primary" data-kt-users-modal-action="submit">
