									...
									<div class="card-body p-9">
										...
										<form id="kt_modal_update_password_form" class="form" method="post" >
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<input type="hidden" id="appointment_patient_id" name="appointment_patient_id" value="<?php if(isset($patient_info->appointment_patient_id)){echo $patient_info->appointment_patient_id;}else{echo $this->uri->segment('3');}?>">
