										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-document')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'patient/add_document/'.$this->uri->segment('3');?>" class="btn btn-primary">
									...
									<!--end::Card header-->
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder fs-3 mb-1"><?php //echo $sub_sidebar;?></span>
												...
												<div class="card-toolbar">
													...
													if ($this->admin->check_user_access('patient-history-list')) {
														?>
														<li class="nav-item">
															<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary <?php if($tab_active=='1st'){echo 'active';}?> fw-bolder px-4 me-1"  href="<?php echo base_url().'patient/patient_history/'.$this->uri->segment('3');?>">Appointment History</a>
														</li>
													...
													if ($this->admin->check_user_access('document-list')) {
														?>
														<li class="nav-item">
															<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary <?php if($tab_active=='2nd'){echo 'active';}?>  fw-bolder px-4 me-1"  href="<?php echo base_url().'patient/document_history/'.$this->uri->segment('3');?>">Document History</a>
														</li>
													<?php
													}
													?>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a class="text-gray-800 text-hover-primary mb-1" target="_blank" href="<?php echo base_url().$value->document_path;?>"><?php 
															echo $value->document_name;
															//echo date("d-M-y h:i A",strtotime($value->appointment_date_time));?></a>
													...
													<td><?php echo date("d-M-y h:i A",strtotime($value->document_created_on));?></td>
													<!--begin::Joined-->
													<!--begin::Action=-->
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'patient/update_appointment/'.$value->appointment_patient_id.'/'.$value->appointment_id;?>" class="menu-link px-3">Edit</a>
															</div>
