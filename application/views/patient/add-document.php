							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-body p-9">
										...
										<!--begin::Form-->
										<form id="kt_modal_update_password_form" class="form" method="post"  enctype="multipart/form-data">


											<!--begin::Input group=-->
											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2"> Document Name</label>
													<input type="text" class="form-control form-control-solid" placeholder="Please enter document name" value="" name="document_name" required/>

						                        	<div style="color: red;"><?php echo form_error('document_name'); ?></div>
											</div>

											<div class="fv-row mb-4">
												<label class="required form-label fs-6 mb-2"> Upload Document</label>
													<input type="file" class="form-control form-control-solid" placeholder="Please " value="" name="document_path" required/>

													<input type="hidden" id="document_patient_id" name="document_patient_id" value="<?php if(isset($patient_info->document_patient_id)){echo $patient_info->document_patient_id;}else{echo $this->uri->segment('3');}?>">

						                        	<div style="color: red;"><?php echo form_error('document_path'); ?></div>
											</div>
