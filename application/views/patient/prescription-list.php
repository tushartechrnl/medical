										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-patient')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'patient/add_prescription';?>" class="btn btn-primary">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px">Patient Name - Phone Number</th>
													<th class="min-w-125px">Doctor Name</th>
													<!-- <th class="min-w-125px">User Name</th> -->
													<th class="min-w-125px">Medicine</th>
													<!-- <th class="min-w-50px">Test</th> -->
													<th class="min-w-50px">Status<!-- Worker --></th>
													<th class="min-w-40px">Created ON</th>
											...
											<tbody class="text-gray-600 fw-bold">
												...
												if ($pre_record) {
													$i=0;
													foreach ($pre_record as $key => $value) {
														$i++;
														?>
												<!--begin::Table row-->
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a class="text-gray-800 text-hover-primary mb-1"><?php echo $value->user_first_name.' '.$value->user_last_name;?> - <?php echo $value->user_phone_number;?></a>
													...
													<!--end::User=-->
													<!--begin::Role=-->
													<td><a class="text-gray-800 text-hover-primary mb-1"><?php echo $value->doctor_first_name.' '.$value->doctor_last_name;?>
															</a></td>
													<!--end::Role=-->
													<!--begin::Two step=-->
													...
													<td class="d-flex align-items-center">
														...
														if (isset($value->pre_details_in_detail)) {
															$predetail_array=json_decode($value->pre_details_in_detail);
															...
															if($predetail_array)foreach ($predetail_array as $key1 => $value1) {
																if (is_array($value1)) {
																	...
																	if($key1=='pre_details'){
																		...
																		echo $predetail_array->pre_details[$key2].' &nbsp;'.$predetail_array->medicine_timings[$key2].' &nbsp;'.$predetail_array->medicine_day_course[$key2].' &nbsp; <br>';
																		}
																	}
													...
													<!-- <td >
															...
															if (isset($value->pre_lab_test)) {
																$pre_lab_test_array=json_decode($value->pre_lab_test);
													...
													?><?php echo date("d-M-y h:i A",strtotime($value->pre_created_on));?></td>
													<!--begin::Joined-->
													<!--begin::Action=-->
													<td class="text-end">
													<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
														...
														<!-- <a href="<?php echo base_url().'patient/update_patient/'.$value->user_id?>" class="btn btn-edit btn-active-edit-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Edit</a> -->
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'patient/show_prescription/'.$value->pre_id?>" class="menu-link px-3">Show</a>
															</div>
																<?php
															//}
															?>
															...
															<?php
															//if ($this->admin->check_user_access('appointment-list')) {
															if ($value->pre_status=="1") {
																
																?>
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'patient/mark_disabled/'.$value->pre_id?>" class="menu-link px-3">Mark Disabled</a>
															</div>
																<?php
															}else{
																?>
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'patient/mark_enabled/'.$value->pre_id?>" class="menu-link px-3">Mark Enabled</a>
															</div>
																<?php
															}
															//}
