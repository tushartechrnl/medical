										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-patient')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'patient/add_payment/'.$this->uri->segment("3").'/'.$this->uri->segment("4");?>" class="btn btn-primary">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px"><!-- Post -->Paid Details</th>
											...
											<tbody class="text-gray-600 fw-bold">
												<?php
												if ($treatment_payment_record) {
													$i=0;
													foreach ($treatment_payment_record as $key => $value) {
														$i++;
														?>
												<!--begin::Table row-->
												<tr>
													...
													<!--end::Last login=-->
													<!--begin::Joined-->
													<td><?php echo $value->payment_paid_via;?> </td>
													...
													<td class="text-end">
														...
														<div class="menu-item px-3">
															<a href="<?php echo base_url().'patient/update_payment/'.$value->payment_id.'/'.$value->payment_user_id;?>" class="menu-link px-3">Edit</a>
