										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-patient')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'patient/add_treatment_advice/'.$this->uri->segment("3");?>" class="btn btn-primary">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<tr>
													...
													<!--end::Last login=-->
													<!--begin::Joined-->
													<td><?php echo $value->ttmad_fees;?> /-</td>
													<td>
														<?php //echo $value->total_payment.' /-';?>
													</td>
													...
													<td class="text-end">
														...
														<div class="menu-item px-3">
															<a href="<?php echo base_url().'patient/update_treatment_advice/'.$value->ttmad_id;?>" class="menu-link px-3">Edit</a>
