...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title><?=$this->lang->line('project_title');?> </title>
		<meta charset="utf-8" />
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to <?=$this->lang->line('project_title');?></h1>
									<!--end::Title-->
									<!--begin::Link-->
								...
								<div class="fv-row mb-10">
									<!--begin::Label-->
									<label class="form-label fs-6 fw-bolder text-dark">Mobile Number</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" type="text" name="user_phone_number" autocomplete="off" />
									<!--end::Input-->
								...
								<div class="text-center">
									...
									<button type="submit" name="btn_submit_login"  class="btn btn-lg btn-primary w-100 mb-5">
