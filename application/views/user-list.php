										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												if ($this->admin->check_user_access('add-user')) {
													?>
												<!--begin::Add user-->
												<a href="<?php echo base_url().'user/add_user';?>" class="btn btn-primary">
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<tr>
													...
													<!--<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
														...
														<a href="<?php echo base_url().'user/update_user/'.$value->user_id?>" class="btn btn-edit btn-active-edit-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Action</a>
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'user/update_user/'.$value->user_id?>" class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
																<?php
															}
															...
															/*if ($this->admin->check_user_access('add-user-vehical')) {
																?>
															<div class="menu-item px-3">
																<a href="<?php echo base_url().'user/user_vehicle/'.$value->user_id?>" class="menu-link px-3">Vehicle</a>
															</div>
																<?php
															}*/
															?>
